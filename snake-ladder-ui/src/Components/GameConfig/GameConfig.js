        ...
        <div className="row justify-content-center">
            ...
            <div className="card mt-5 ">
              <div className="card-body ">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
             <label htmlFor="boardColumns" className="form-label fw-bold">
               Board Columns:
             </label>
             <input
              type="number"
          ...
          <div className="mb-3">
            ...
            />
                  ...
                  <div className="mb-3">
                    <label className="form-label fw-bold">Snake and Ladder:</label>
                    <p>
               For Snake: Start Position {">"} End Position{" "}
               <img
                src={Snake}
            ...
            {snakeOrLadder.map((position, index) => (
              <div key={index} className="d-flex">
                ...
                />
                  ...
                  <button type="submit" className="mt-5  game-config-btn-whimsical">Create Game</button>
                </form>
              </div>
            </div>
          </div>
